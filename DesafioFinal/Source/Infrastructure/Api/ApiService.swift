...
final class ApiService{
    ...
    private struct Constants{
        static let APIKey = "A4740D6E-C805-482A-B6D2-EA3FB59B28CB"
    ...
    func getCriptoCoins(completion: @escaping (Result<[CriptoData], Error>)-> Void){
        ...
        let dataTask = URLSession.shared.dataTask(with: url) { (data, _, error) in
            ...
            do {
                ...
                completion(.success(decoder.sorted{ first, second -> Bool in
    ...
    public func getAllIcons(){
        ...
        guard let url = URL(string: "https://rest.coinapi.io/v1/assets/icons/55/?apikey=A4740D6E-C805-482A-B6D2-EA3FB59B28CB") else { return }
